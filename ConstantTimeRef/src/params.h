...
#define PK_COMPRESS
  ...
  #define WEAVER_NAMESPACE(s) pqcrystals_weaver512_ref##s
  #define WEAVER_ETA1 5
  // #define WEAVER_ETA2 4  /* legacy setting */
  ...
  #define WEAVER_NAMESPACE(s) pqcrystals_weaver1024_ref##s
  ...
  #define WEAVER_PK_POLYVECBYTES        (WEAVER_K * ((WEAVER_N * 9) / 8))
  #define WEAVER_POLYVECCOMPRESSEDBYTES (WEAVER_K * ((WEAVER_N * 9) / 8))
  #define WEAVER_POLYCOMPRESSEDBYTES    ((WEAVER_N * 5) / 8)

#elif (WEAVER_MODE == 5)
  #define WEAVER_N 512
  #define WEAVER_INDCPA_MSGBYTES       (WEAVER_N / 8)
  #define WEAVER_NAMESPACE(s) pqcrystals_weaver2048_ref##s
