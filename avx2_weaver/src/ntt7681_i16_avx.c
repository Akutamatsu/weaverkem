/*
 * q=7681, n=256 negacyclic NTT — 16-bit AVX2 Montgomery (standalone experiment).
 * Canonical [0,q) coefficients; not bit-compatible with ref/ntt.c.
 */
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
...
void ntt7681_i16_ntt(uint16_t a[N])
{
  q7681_forward_negacyclic_i16_avx2(a);
}

void ntt7681_i16_invntt(uint16_t a[N])
{
  q7681_inverse_negacyclic_i16_avx2(a);
}

void ntt7681_i16_basemul(uint16_t r[N], const uint16_t a[N], const uint16_t b[N])
{
  q7681_basemul_i16_avx2(r, a, b);
}
