...
#define ntt_avx WEAVER_NAMESPACE(_ntt_avx)
void ntt_avx(int16_t *r, const int16_t *qdata);

#define invntt_avx WEAVER_NAMESPACE(_invntt_avx)
void invntt_avx(int16_t *r, const int16_t *qdata);

#define basemul_avx WEAVER_NAMESPACE(_basemul_avx)
void basemul_avx(int16_t *r, const int16_t *a, const int16_t *b,
                 const int16_t *qdata);

#define reduce_avx WEAVER_NAMESPACE(_reduce_avx)
int16_t reduce_avx(int16_t *r, const int16_t *qdata);

#define tomont_avx WEAVER_NAMESPACE(_tomont_avx)
int16_t tomont_avx(int16_t *r, const int16_t *qdata);

#define qdata WEAVER_NAMESPACE(_qdata)
extern const int16_t WEAVER_NAMESPACE(_qdata)[];

#define ntttobytes_avx WEAVER_NAMESPACE(_ntttobytes_avx)
void ntttobytes_avx(uint8_t *r, const int16_t *a, const int16_t *qdata);

#define nttfrombytes_avx WEAVER_NAMESPACE(_nttfrombytes_avx)
void nttfrombytes_avx(int16_t *r, const uint8_t *a, const int16_t *qdata);

#define nttunpack_avx WEAVER_NAMESPACE(_nttunpack_avx)
