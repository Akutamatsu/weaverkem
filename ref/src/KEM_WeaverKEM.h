...
#ifndef KEM_WEAVERKEM_H
#define KEM_WEAVERKEM_H
...
/* Algorithm instance name */
  ...
  #define ALGORITHM_INSTANCE "WeaverKEM-128-SHAKE"
#else
  #define ALGORITHM_INSTANCE "WeaverKEM-128"
#endif
#elif (WEAVER_MODE == 3)
#ifdef WEAVER_USE_SHAKE
  #define ALGORITHM_INSTANCE "WeaverKEM-256-SHAKE"
#else
  #define ALGORITHM_INSTANCE "WeaverKEM-256"
#endif
#elif (WEAVER_MODE == 5)
#ifdef WEAVER_USE_SHAKE
  #define ALGORITHM_INSTANCE "WeaverKEM-512-SHAKE"
#else
  #define ALGORITHM_INSTANCE "WeaverKEM-512"
#endif
#else
